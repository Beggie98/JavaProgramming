...
public class ThunderBlazz {
    public static void main(String[] args) {
        ...
        System.out.println(getThunderBlazz(input.nextBoolean(), input.nextBoolean(), input.nextInt(), input.nextInt(), input.nextInt()));
    ...
    public static boolean getThunderBlazz(boolean availableAtStore, boolean gift, int ingredient1,
                                          int ingredient2, int ingredient3){

        boolean valid = (availableAtStore == true) || (gift == true) ||
                ((ingredient1 == 1 && ingredient2 == 2 && ingredient3 == 3) || (ingredient1 == 3 && ingredient2 == 1 && ingredient3 == 2));
